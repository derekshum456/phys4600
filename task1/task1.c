...
int main()
{
	float data [] ={0.068038, 0.173967, 0.439303, 0.615258, 0.789436, 0.770980, 0.890924, 1.034431, 0.955555, 0.991579, 0.919359, 0.857244, 
	...
	printf("sum = %f" ,sum); // sum of the numbers
	mean = sum/32; //first set of means

	for (int i = 0; i < 32; ++i)
	{
		step1 += pow((data[i] - mean),2); //numbers needed for the mean2
